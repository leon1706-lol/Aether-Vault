...
def test_migration_chain_resolves_to_single_head():
    ...
    assert heads == ["0017"], f"unexpected heads: {heads}"
...
def test_chain_renders_downgrade_ddl_offline_for_every_revision():
    ...
    assert chain == ["0017", "0016", "0015", "0014", "0013", "0012", "0011", "0010", "0009", "0008", "0007",
    ...
    expected_per_step = {
        "0017": ["DROP INDEX", "ix_commits_project_timestamp"],
